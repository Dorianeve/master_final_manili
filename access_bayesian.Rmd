...
## perception variable P(Perception|Q7.1)
...
## discrepancy of needs reported on denial of needs P(Q1.1|Q1.2)
denial_needs()
## complex registration on discrepancy of needs P(Q1.2|Q3.1)
discrepancy_needs()
## admin requirements to access assistance on complex registration P(Q3.1|Q2.2)
burocracy()
## violence on interference in aid delivery P(Q5.1|Q7.1)
interference_violence()
## interference in aid delivery on denial of the right to assistance P(Q1.3|Q5.1)
interference_assistance()
## denial of right to assistance on forced displacement away from services P(Q2.3|Q1.3)
denial_displacement()
## violence on agencies being on hold P(Q4.5|Q7.1)
onhold_violence()
## violence on Counterterrorism measures affecting operations P(Q5.2|Q7.2)
violence_counterterrorism()
## violence on relocation of staff or suspension of operations P(Q7.3|Q7.2)
violence_operations()
## logistical goods constraints on imports and visas constraints P(Q3.3|Q9.3)
log_imports()
## imports and visa constraints on presence of checkpoints P(Q4.3|Q3.3)
imports_checkpoints()
## landmine contamination on casualties of landmines P(Q8.2|Q8.1)
landmine_casualties()
## territory controlled by different actors on perception P(Perception|Q4.1)
perception_territory()
## violence on perception P(Perception|Q7.1)
perception_violence()
